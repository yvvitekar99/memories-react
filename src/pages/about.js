...
function About() {
  return (
    <div className="flex flex-col items-center">
      <div className="font-Dancing text-5xl mb-[60px] mt-[50px]">About Me</div>
      ...
      <div className="flex flex-col items-center">
        <p className="max-w-[1000px] m-[20px] text-xl font-Oswald	">
          Talking About Yourself Is A Bit Difficult. Anyway Hello, Sanket Patwe
          Here A Photographer By Professional{" "}
        </p>
        <p className="max-w-[1000px] m-[20px] text-xl font-Oswald	">
