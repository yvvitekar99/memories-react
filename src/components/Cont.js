  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center">
        <section class="bg-white py-20 lg:py-[120px] overflow-hidden relative z-1 w-[75%]">
          <div class="container">
            <div class="flex flex-wrap lg:justify-between -mx-4">
              <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                <div class="max-w-[570px] mb-12 lg:mb-0">
                 ...
                 {width>450? <div class="flex mb-8 max-w-[370px] w-full">
                    <div
                      class="
                     max-w-[60px]
                     sm:max-w-[70px]
              ...
              <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-2xl">
